...
module.exports = {
    generateWorkoutPlan: async function (userId, lengthMin, targetMuscleGroup, dbConfig) {
        ...
        //const workoutPlanId = await data.createWorkoutPlanEntry(userId, dbConfig); ADD BACK LATER
